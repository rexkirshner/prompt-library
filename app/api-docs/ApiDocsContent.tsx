 ...
 *
 * Client component that dynamically displays the base URL based on current hostname.
 * This ensures the docs work correctly in development, staging, and production.
 */

import { useState, useEffect } from 'react'

export function ApiDocsContent() {
  const [baseUrl, setBaseUrl] = useState<string>('/api/v1')

  useEffect(() => {
    // Set the full base URL once mounted on client
