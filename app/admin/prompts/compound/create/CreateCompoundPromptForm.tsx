/**
 * Create Compound Prompt Form Component
 *
 * Client component for creating new compound prompts with validation.
 */
...
function SubmitButton() {
  ...
  return (
    ...
    >
      {pending ? 'Creating compound prompt...' : 'Create Compound Prompt'}
    </button>
  )
}

interface CreateCompoundPromptFormProps {
  availablePrompts: BasePromptOption[]
}

/**
 * Create compound prompt form with validation and error handling
 */
export function CreateCompoundPromptForm({
  availablePrompts,
}: CreateCompoundPromptFormProps) {
  ...
  const handleSubmit = async (
    ...
    return createCompoundPrompt(data)
  }
